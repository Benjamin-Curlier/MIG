namespace MIG.Scripts.Common
{
    ...
    [CreateAssetMenu(fileName = "ObjectPool", menuName = "PoolGenerator/New", order = 1)]
    public class ObjectPool : ScriptableObject
    {
        ...
        public GameObject GetObject()
        {
            ...
            spawnedGameObject.transform.localScale = new Vector3(1 / spawnedGameObject.transform.lossyScale.x, 1 / spawnedGameObject.transform.lossyScale.y, 1 / spawnedGameObject.transform.lossyScale.z);
