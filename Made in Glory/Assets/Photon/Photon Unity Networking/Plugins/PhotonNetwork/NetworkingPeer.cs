...
#region Operations and Connection Methods
    ...
    {
        IPunCallbacks target = PhotonNetwork.CallbacksTarget;
        ...
        if (target != null)
        {
            switch (methodString)
            {
                ...
                case PhotonNetworkingMessage.OnConnectedToPhoton:
                    target.OnConnectedToPhoton();
                    break;
                case PhotonNetworkingMessage.OnDisconnectedFromPhoton:
                    target.OnDisconnectedFromPhoton();
                    break;
                case PhotonNetworkingMessage.OnFailedToConnectToPhoton:
                    target.OnFailedToConnectToPhoton((DisconnectCause)parameters[0]);
                    break;
                ...
                case PhotonNetworkingMessage.OnLobbyStatisticsUpdate:
                    target.OnLobbyStatisticsUpdate();
                    break;
